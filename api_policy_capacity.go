...
type PolicyCapacityApiService service
/*
PolicyCapacityApiService Returns capacity usage data for NSX objects
Returns capacity usage data for NSX objects
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PolicyCapacityApiGetPolicyCapacityUsageOpts - Optional Parameters:
...
type PolicyCapacityApiGetPolicyCapacityUsageOpts struct { 
...
func (a *PolicyCapacityApiService) GetPolicyCapacityUsage(ctx context.Context, localVarOptionals *PolicyCapacityApiGetPolicyCapacityUsageOpts) (PolicyCapacityUsageResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PolicyCapacityUsageResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/global-infra/capacity/usage"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PolicyCapacityUsageResponse
...
Returns capacity usage data for NSX objects
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PolicyCapacityApiGetPolicyCapacityUsage_1Opts - Optional Parameters:
     * @param "Category" (optional.String) - 
     * @param "Cursor" (optional.String) -  Opaque cursor to be used for getting next page of records (supplied by current result page)
     * @param "IncludedFields" (optional.String) -  Comma separated list of fields that should be included in query result
     * @param "PageSize" (optional.Int64) -  Maximum number of results to return in this page (server may return fewer)
...
type PolicyCapacityApiGetPolicyCapacityUsage_1Opts struct { 
	Category optional.String
	Cursor optional.String
	IncludedFields optional.String
	PageSize optional.Int64
...
func (a *PolicyCapacityApiService) GetPolicyCapacityUsage_1(ctx context.Context, localVarOptionals *PolicyCapacityApiGetPolicyCapacityUsage_1Opts) (PolicyCapacityUsageResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/infra/capacity/usage"
