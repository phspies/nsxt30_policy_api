...
**VtepLabel** | **int64** | The label of VTEP | [optional] [default to null]
**ReplicationType** | **string** | This field specifies the type of replication message TX_VTEP - Transmit replication to all VTEPs TX_MTEP - Transmit replication to all MTEPs RX - Receive replication | [optional] [default to null]
**LocalIpAddress** | **string** | Local IP address of the component that replicates the packet. | [optional] [default to null]
**UplinkName** | **string** | The name of uplink | [optional] [default to null]
