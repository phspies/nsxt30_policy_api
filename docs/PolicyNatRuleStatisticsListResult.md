...
**Results** | [**[]PolicyNatRuleStatisticsPerEnforcementPoint**](PolicyNatRuleStatisticsPerEnforcementPoint.md) | NAT rules statistics per enforcement point | [default to null]
