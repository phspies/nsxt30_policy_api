...
**PageSize** | **int32** | Number of records per page. page_size will be effective only when the urls provided in the datasource support paging. | [optional] [default to 30]
**RowListFields** | [**[]RowListField**](RowListField.md) | Rows of grid or table are formed from the list of objects returned by a row list field. | [default to null]
**Columns** | [**[]ColumnItem**](ColumnItem.md) | Array of columns of a Grid widget | [default to null]
