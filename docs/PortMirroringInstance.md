...
**Direction** | **string** | Port mirroring instance direction | [optional] [default to null]
**DestinationGroup** | **string** | Data from source group will be copied to members of destination group.  | [default to null]
